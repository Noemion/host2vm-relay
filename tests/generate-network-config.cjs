...
const c={
 ...
 tun:{enable:true,stack:'gvisor',device:'h2vmtest','auto-route':true,'auto-detect-interface':false,
   'route-include-address':['198.18.0.0/16','198.19.0.0/24'], 'route-exclude-address':['10.203.0.0/24'],'dns-hijack':['any:53']},
 'interface-name':'eth0',
 dns:{enable:true,listen:'127.0.0.1:53',nameserver:['1.1.1.1'],'fake-ip-range':'198.18.0.1/16'},
...
for(const name of ['host2vm-relay-rules','host2vm-relay-udp-rules'])result['rule-providers'][name]={type:'inline',behavior:'classical',payload:['IP-CIDR,198.19.0.0/24,no-resolve','DOMAIN,intranet.h2vm.test']};
